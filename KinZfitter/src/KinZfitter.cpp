...
void KinZfitter::initZs(std::vector< reco::Candidate* > selectedLeptons, std::map<unsigned int, TLorentzVector> selectedFsrPhotons){
        ...
        for(unsigned int ifsr = 0; ifsr<selectedLeptons.size(); ifsr++)
         {
...
//void KinZfitter::Setup2L2Q(std::vector< reco::Candidate* > selectedLeptons, std::map<unsigned int, TLorentzVector> selectedFsrPhotons, std::vector<TLorentzVector> Zhad, JME::JetResolution resolution_pt, double rho){
...
>>>>>>> f4484b5672219489981f89d50e60a7071a02f837
{
...
>>>>>>> f4484b5672219489981f89d50e60a7071a02f837
    ...
    double RECOpT1min = max(5.0, RECOpT1-5*pTerrZ1_1);
    double RECOpT2min = max(5.0, RECOpT2-5*pTerrZ1_2);
